                ...
                if ($user_pass === $user_pass_repeat) {
                    ...
                    if ($db_q_create) {
                        ...
                        if ($q_create_numrows > 0) {
                            ...
                            header("Location: ../signup.php?c=1&id=$user_new&error=user successfully created");
                            exit();
                        }
                    } else {
                        header("Location: ../signup.php?message=Something went wrong, user was not created, try again&$loc");
                        exit();
                    }
