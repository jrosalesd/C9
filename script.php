	...
	if ($_GET['scr']==0) {
	       ?>
            ...
            if ($_GET['app']==1) {
               ?>
                <p>
                    <mark style="background-color:yellow;">All applications must be verbally confirmed with the individual whose name the loan is under. You may not confirm a loan with a spouse, child, or other party. Should that be requested, we will need to view the Power of Attorney Documentation.</mark>
                </p> 
                ...
                <p>Or <br>email to: <?php echo $email;?></p>
                ...
                <p>Or <br>email to: julio.r@spotloan.com</p>
