...
//**********************************
$(document).ready(function() {
    setInterval(alaska, 500);
});

function alaska() {
    $.ajax({
        url: 'includes/time.php?id=1',
        success: function(data) {
            $('#alaskaWriteTimes').html(data);
        },
    });
}
//****************************************
...
$(document).ready(function() {
    setInterval(hawaii, 500);
});

function hawaii() {
    $.ajax({
        url: 'includes/time.php?id=2',
        success: function(data) {
            $('#hawaiiWriteTimes').html(data);
        },
    });
}
//****************************************
...
$(document).ready(function() {
    setInterval(pacific, 500);
});

function pacific() {
    $.ajax({
        url: 'includes/time.php?id=3',
        success: function(data) {
            $('#pacificWriteTimes').html(data);
        },
    });
}
//****************************************
$(document).ready(function() {
    setInterval(moutain, 500);
});

function moutain() {
    $.ajax({
        url: 'includes/time.php?id=4',
        success: function(data) {
            $('#mountainWriteTimes').html(data);
        },
    });
}
//****************************************
$(document).ready(function() {
    setInterval(central, 500);
});

function central() {
    $.ajax({
        url: 'includes/time.php?id=5',
        success: function(data) {
            $('#centralWriteTimes').html(data);
        },
    });
}
//****************************************
$(document).ready(function() {
    setInterval(eastern, 500);
});

function eastern() {
    $.ajax({
        url: 'includes/time.php?id=6',
        success: function(data) {
            $('#easternWriteTimes').html(data);
        },
    });
}
//****************************************
