...
<div class="jumbotron">
        ...
        if ($seclevel<3) {
            if (!empty($_GET['id'])) {
               ...
               if (isset($_POST['state_update'])) {
                   ...
                   $q = "UPDATE servicing_states SET state_status='$state_status', state_dc_status='$state_dc_status' WHERE id='$state_id'";
            ...
            <table class="table table-states table-hover">
                ...
                <?php
                include 'includes/dbh.inc.php';
                $q = "SELECT * FROM servicing_states ORDER BY state_status DESC, state_dc_status ASC, state_name ASC";
                $query = mysqli_query($conn, $q);
                $numrow = mysqli_num_rows($query);
                if ($numrow > 0) {
                    $row = mysqli_fetch_array($query);
    ...
    <div class="centered" >
        <table class="timezone_table" onload="startTime()">
            ...
            <tr>
                <td class="bd text-center centered"><g id="hawaiiWriteTimes"></g></td>
                <td class="bd text-center centered"><g id="alaskaWriteTimes"></g></td>
                <td class="bd text-center centered"><g id="pacificWriteTimes"></g></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="bd text-center centered"><g id="mountainWriteTimes"></g></td>  
                <td class="bd text-center centered"><g id="centralWriteTimes"></g></td>
                <td class="bd text-center centered"><g id="easternWriteTimes"></g></td>
            </tr>
        </table>
    </div>
    <div>
